...
import { SectionCardsEditable } from "../features/section/components/SectionCardEditable";
...
export function EditPage({ onNavigateToView }: ViewPageProps) {
    return (
        <main className="flex flex-col items-center justify-center pt-16 pb-4">
            ...
            <section className="max-w-5xl flex flex-col gap-4">
                <SectionCardsEditable sections={sectionsTest} />
            </section>
        </main>
    );
}
